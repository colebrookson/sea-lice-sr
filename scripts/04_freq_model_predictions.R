...
farm_regress = readr::read_csv(
    here::here("./data/regression-data/farm-regression-data.csv"))
...
saveRDS(wild_to_focal_farms, 
    here::here("./data/model-outputs/wild-lice-to-focal-farms-gam.RDS"))
...
saveRDS(log_wild_to_log_focal_farms, 
    here::here("./data/model-outputs/log-wild-lice-to-log-focal-farms-lm.RDS"))
...
farm_grouping_comp = ggplot(data = comp_data, 
    ...
    annotate(geom = "text", 
                ...
                size = 7,
                parse = TRUE)
ggsave(filename = here::here("./figs/farm-grouping-comparison.png"),

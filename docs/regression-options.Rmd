...
# pred_cope_2002_2004 = data.frame(
#   all_cope = df_2002_2004[which(!is.na(df_2002_2004$all_cope)), "all_cope"],
#   pred_prop = stats::predict(
#     cope_reg,
#     data.frame(all_cope = df_2002_2004[which(!is.na(df_2002_2004$all_cope)), "all_cope"]),
#     type = "response")
# )
...
```
The plot above is for motiles, the black line is the regression prediction line. The mean value for the number of motiles in 2001 is 2.175373, and that is denoted by the blue vertical line.
...
ggplot() + 
  ...
  # geom_point(data = pred_cope_2002_2004, aes(x = all_cope, y = pred_prop),
  #            shape = 21,
  #            colour = "black",
  #            fill = "purple",
  #            size = 2,
...
# Regression Attempt with All Lice instead of just Motiles
